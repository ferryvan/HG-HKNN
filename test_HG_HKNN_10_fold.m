...
for v = 1:k_fold  
        ...
        [predict_y,distance_s,score_f] = HG_HKNN(train_x,train_y,test_x,k_nn,lammda,gamma,beta,type);
        %[predict_y,distance_s,score_f] = hknn(train_x,train_y,test_x,k_nn,lammda);
